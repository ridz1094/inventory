...
RSpec.describe ItemsController, type: :controller do
  ...
  let(:valid_attributes) { {id: "1", name: "Item 1", item_category_id: item_category.id} }

  let(:invalid_attributes) { {id: "1", name: "", item_category_id: item_category.id} }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) { {id: "1", name: "Item 1", item_category_id: item_category.id} }
